...
chart_visual=st.sidebar.selectbox('select charts/plot type',('Linechart','BarChart','Bubble Chart'))
...
if chart_visual=='Linechart':
    ...
    if selected_status=='Smoked':
        fig.add_trace(go.Bar(x=data.Country,y=data.Smoked,
                                 name='Smoked'))
